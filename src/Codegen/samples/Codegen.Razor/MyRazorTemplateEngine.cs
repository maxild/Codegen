...
{
    // Note: The RazorTemplateEngine has been removed from next version (https://github.com/dotnet/aspnetcore/issues/25215)
    // TODO: Remove this sample!!!

    /// <summary>
    /// Entry point to parse Razor files and generate code.
    /// </summary>
    public class MyRazorTemplateEngine
    {
        // private RazorTemplateEngineOptions _options;

        /// <summary>
        /// Initializes a new instance of <see cref="MyRazorTemplateEngine"/>.
        /// </summary>
        /// <param name="engine">The <see cref="RazorEngine"/>.</param>
        /// <param name="project">The <see cref="RazorProject"/>.</param>
        public MyRazorTemplateEngine(
            RazorEngine engine,
        ...
        // /// <summary>
        // /// Options to configure <see cref="MyRazorTemplateEngine"/>.
        // /// </summary>
        ...
        public RazorCSharpDocument GenerateCode(string path)
        {
            ...
            {
                throw new ArgumentException("ArgumentCannotBeNullOrEmpty", nameof(path));
            }

            var projectItem = Project.GetItem(path, null);
